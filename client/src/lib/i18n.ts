const ar = {
  ...
  conflict: { driverBusy: "تنبيه: السائق مشغول حالياً", activeTrip: "مشوار نشط", activeShopping: "طلب تسوق قيد التنفيذ", tripTo: "مشوار إلى", orderNum: "طلب رقم", proceedAnyway: "متابعة رغم ذلك", driverAvailable: "السائق متاح", timeConflict: "تعارض في الموعد" },
...
const en: typeof ar = {
  ...
  conflict: { driverBusy: "Warning: Driver is currently busy", activeTrip: "Active Trip", activeShopping: "Shopping order in progress", tripTo: "Trip to", orderNum: "Order #", proceedAnyway: "Proceed Anyway", driverAvailable: "Driver available", timeConflict: "Time conflict" },
