const ar = {
  ...
  attachments: { title: "المرفقات", downloadTemplate: "نموذج فارغ", exportProducts: "تصدير المنتجات", uploadExcel: "رفع ملف Excel", uploading: "جاري الرفع...", processing: "جاري معالجة الملف...", importSuccess: "تم استيراد المنتجات بنجاح", importFailed: "فشل استيراد الملف", exportFailed: "فشل تصدير المنتجات", productsImported: "منتج تم استيراده", productsSkipped: "منتج تم تخطيه (مكرر)", productsUpdated: "منتج تم تحديثه", selectFile: "اختر ملف Excel", dragDrop: "أو اسحب وأفلت الملف هنا", templateDesc: "حمّل النموذج، أضف المنتجات فيه من جهازك، ثم ارفعه هنا", invalidFile: "ملف غير صالح. يرجى رفع ملف Excel (.xlsx)", noData: "الملف لا يحتوي على بيانات", importReport: "تقرير الاستيراد", newProducts: "منتجات جديدة", existingUpdated: "منتجات محدّثة", errors: "أخطاء", errorDetails: "تفاصيل الأخطاء" },
...
const en: typeof ar = {
  ...
  attachments: { title: "Attachments", downloadTemplate: "Blank Template", exportProducts: "Export Products", uploadExcel: "Upload Excel File", uploading: "Uploading...", processing: "Processing file...", importSuccess: "Products imported successfully", importFailed: "Import failed", exportFailed: "Export failed", productsImported: "products imported", productsSkipped: "products skipped (duplicate)", productsUpdated: "products updated", selectFile: "Select Excel File", dragDrop: "or drag and drop file here", templateDesc: "Download the template, add products on your device, then upload it here", invalidFile: "Invalid file. Please upload an Excel file (.xlsx)", noData: "File contains no data", importReport: "Import Report", newProducts: "New products", existingUpdated: "Updated products", errors: "Errors", errorDetails: "Error details" },
