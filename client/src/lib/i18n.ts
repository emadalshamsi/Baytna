...
const en: typeof ar = {
  ...
  admin: { approvePermission: "Approval Permission", noApproval: "No Approval", orderStatusUpdated: "Order status updated", userRoleUpdated: "User role updated", categoryAdded: "Category added", storeAdded: "Store added", storeUpdated: "Store updated", iconCode: "Icon code (e.g. milk)", addProduct: "Add Product", addCategory: "Add Category", addStore: "Add Store", editProduct: "Edit Product", editCategory: "Edit Category", editStore: "Edit Store", suspendUser: "Suspend", activateUser: "Activate", userSuspended: "User suspended", userActivated: "User activated", suspended: "Suspended", addUser: "Add User", userCreated: "User created", usernameExists: "Username already exists" },
