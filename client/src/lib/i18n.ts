const ar = {
  ...
  trips: { title: "المشاوير", addTrip: "إضافة مشوار", personName: "اسم الشخص", location: "الموقع", departureTime: "موعد التحرك", estimatedDuration: "المدة المتوقعة للعودة", vehicle: "السيارة", noTrips: "لا توجد مشاوير", tripAdded: "تمت إضافة المشوار", tripUpdated: "تم تحديث المشوار", saveFailed: "فشل حفظ المشوار", selectVehicle: "اختر السيارة", selectDriver: "اختر السائق", selectLocation: "اختر الموقع", coordination: "تنسيق", coordinateWith: "تنسيق مع فني", coordinationCreated: "تم إنشاء مشوار التنسيق", minutes: "دقيقة", seconds: "ثانية", departureRequired: "يجب تحديد موعد التحرك", approvePermission: "اعتماد المشاوير" },
...
const en: typeof ar = {
  ...
  trips: { title: "Trips", addTrip: "Add Trip", personName: "Person Name", location: "Location", departureTime: "Departure Time", estimatedDuration: "Estimated Return Duration", vehicle: "Vehicle", noTrips: "No trips", tripAdded: "Trip added", tripUpdated: "Trip updated", saveFailed: "Failed to save trip", selectVehicle: "Select Vehicle", selectDriver: "Select Driver", selectLocation: "Select Location", coordination: "Coordination", coordinateWith: "Coordinate with Technician", coordinationCreated: "Coordination trip created", minutes: "min", seconds: "sec", departureRequired: "Departure time is required", approvePermission: "Approve Trips" },
