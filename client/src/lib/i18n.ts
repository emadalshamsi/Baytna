const ar = {
  ...
  actions: { add: "إضافة", edit: "تعديل", delete: "حذف", save: "حفظ", cancel: "إلغاء", approve: "اعتماد", reject: "رفض", login: "تسجيل الدخول", logout: "تسجيل الخروج", search: "بحث", searchProducts: "بحث في المنتجات...", confirm: "تأكيد", back: "رجوع", submit: "إرسال", update: "تحديث", duplicate: "تكرار" },
...
const en: typeof ar = {
  ...
  actions: { add: "Add", edit: "Edit", delete: "Delete", save: "Save", cancel: "Cancel", approve: "Approve", reject: "Reject", login: "Login", logout: "Logout", search: "Search", searchProducts: "Search products...", confirm: "Confirm", back: "Back", submit: "Submit", update: "Update", duplicate: "Duplicate" },
