const ar = {
  ...
  stats: { totalOrders: "إجمالي الطلبات", pendingOrders: "طلبات معلقة", completedOrders: "طلبات مكتملة (هذا الأسبوع)", totalSpent: "إجمالي الإنفاق (هذا الشهر)", thisWeek: "هذا الأسبوع", thisMonth: "هذا الشهر" },
...
const en: typeof ar = {
  ...
  stats: { totalOrders: "Total Orders", pendingOrders: "Pending Orders", completedOrders: "Completed (This Week)", totalSpent: "Total Spent (This Month)", thisWeek: "This Week", thisMonth: "This Month" },
  ...
  admin: { approvePermission: "Approval Permission", noApproval: "No Approval", orderStatusUpdated: "Order status updated", userRoleUpdated: "User role updated", categoryAdded: "Category added", storeAdded: "Store added", storeUpdated: "Store updated", iconCode: "Icon code (e.g. milk)", addProduct: "Add Product", addCategory: "Add Category", addStore: "Add Store", editProduct: "Edit Product", editCategory: "Edit Category", editStore: "Edit Store" },
};
