const ar = {
  ...
  nav: { dashboard: "الرئيسية", products: "المنتجات", categories: "التصنيفات", orders: "الطلبات", users: "المستخدمين", settings: "الإعدادات", shopping: "التسوق", addItems: "إضافة طلب", stores: "المتاجر", vehicles: "السيارات", trips: "المشاوير", technicians: "دليل الفنيين", spareParts: "قطع الغيار", logistics: "الخدمات", homeManagement: "إدارة المنزل", shoppingSection: "المشتريات والطلبات", logisticsSection: "السيارات والمشاوير", quickLinks: "روابط سريعة", viewAll: "عرض الكل", locations: "المواقع", groceries: "المشتريات", housekeeping: "المنزل", comingSoon: "قريباً", housekeepingDesc: "سيتم إضافة هذا القسم قريباً", profile: "الملف الشخصي" },
  actions: { add: "إضافة", edit: "تعديل", delete: "حذف", save: "حفظ", cancel: "إلغاء", approve: "اعتماد", reject: "رفض", login: "تسجيل الدخول", logout: "تسجيل الخروج", search: "بحث", searchProducts: "بحث في المنتجات...", confirm: "تأكيد", back: "رجوع", submit: "إرسال", update: "تحديث", duplicate: "تكرار", reset: "إعادة ضبط" },
  ...
  spareParts: { title: "قطع الغيار", addPart: "إضافة قطعة غيار", editPart: "تعديل قطعة غيار", noParts: "لا توجد قطع غيار", partAdded: "تمت إضافة قطعة الغيار", partUpdated: "تم تحديث قطعة الغيار", partDeleted: "تم حذف قطعة الغيار", searchParts: "بحث في قطع الغيار...", allCategories: "جميع التصنيفات", addCategory: "إضافة تصنيف", editCategory: "تعديل تصنيف", categoryAdded: "تمت إضافة التصنيف", categoryUpdated: "تم تحديث التصنيف", categoryDeleted: "تم حذف التصنيف", noCategories: "لا توجد تصنيفات", manageCategories: "إدارة التصنيفات", cart: "ق.غ.", emptyCart: "السلة فارغة", sendOrder: "إرسال الطلب", orderCreated: "تم إنشاء طلب قطع الغيار", orders: "طلبات قطع الغيار", noOrders: "لا توجد طلبات", price: "السعر", assignedTo: "المكلف بالشراء", myself: "بنفسي", selectBuyer: "اختر من يشتري" },
  ...
  reports: { title: "التقارير والإحصائيات", topProducts: "أكثر المنتجات طلباً", priceComparison: "مقارنة الأسعار", monthlySpending: "الإنفاق الشهري", categorySpending: "الإنفاق حسب التصنيف", orderStatus: "حالات الطلبات", estimated: "التقديري", actual: "الفعلي", difference: "الفارق", times: "مرة", noData: "لا توجد بيانات كافية للتقارير", totalSpent: "إجمالي الإنفاق", avgPrice: "متوسط السعر", higherThanEstimated: "أعلى من التقديري", lowerThanEstimated: "أقل من التقديري", orders: "طلبات", month: "الشهر", amount: "المبلغ" },
  attachments: { title: "المرفقات", downloadTemplate: "نموذج فارغ", exportProducts: "تصدير المنتجات", exportZip: "تصدير مضغوط", uploadExcel: "رفع ملف Excel", uploading: "جاري الرفع...", processing: "جاري المعالجة...", importSuccess: "تم استيراد المنتجات بنجاح", importFailed: "فشل استيراد الملف", exportFailed: "فشل تصدير المنتجات", productsImported: "منتج تم استيراده", productsSkipped: "منتج تم تخطيه (مكرر)", productsUpdated: "منتج تم تحديثه", selectFile: "اختر ملف Excel", selectFileZip: "اختر ملف Excel أو ZIP", dragDrop: "أو اسحب وأفلت الملف هنا", templateDesc: "حمّل النموذج، أضف المنتجات فيه من جهازك، ثم ارفعه هنا", invalidFile: "ملف غير صالح. يرجى رفع ملف Excel (.xlsx)", invalidFileZip: "ملف غير صالح. يرجى رفع ملف Excel (.xlsx) أو ZIP", noData: "الملف لا يحتوي على بيانات", importReport: "تقرير الاستيراد", newProducts: "منتجات جديدة", existingUpdated: "منتجات محدّثة", imagesLinked: "صور مرتبطة", errors: "أخطاء", errorDetails: "تفاصيل الأخطاء", zipInfo: "استيراد/تصدير مع الصور (ZIP)", zipImportDesc: "استيراد: ملف ZIP يحتوي على Excel + صور مسماة بالكود (مثال: P001.jpg)", zipExportDesc: "تصدير: ملف ZIP يحتوي على Excel + جميع صور المنتجات" },
...
const en: typeof ar = {
  ...
  nav: { dashboard: "Dashboard", products: "Products", categories: "Categories", orders: "Orders", users: "Users", settings: "Settings", shopping: "Shopping", addItems: "Add Items", stores: "Stores", vehicles: "Vehicles", trips: "Trips", technicians: "Technicians", spareParts: "Spare Parts", logistics: "Services", homeManagement: "Home Management", shoppingSection: "Shopping & Orders", logisticsSection: "Vehicles & Trips", quickLinks: "Quick Links", viewAll: "View All", locations: "Locations", groceries: "Groceries", housekeeping: "Home", comingSoon: "Coming Soon", housekeepingDesc: "This section will be added soon", profile: "Profile" },
  actions: { add: "Add", edit: "Edit", delete: "Delete", save: "Save", cancel: "Cancel", approve: "Approve", reject: "Reject", login: "Login", logout: "Logout", search: "Search", searchProducts: "Search products...", confirm: "Confirm", back: "Back", submit: "Submit", update: "Update", duplicate: "Duplicate", reset: "Reset" },
  ...
  spareParts: { title: "Spare Parts", addPart: "Add Spare Part", editPart: "Edit Spare Part", noParts: "No spare parts", partAdded: "Spare part added", partUpdated: "Spare part updated", partDeleted: "Spare part deleted", searchParts: "Search spare parts...", allCategories: "All Categories", addCategory: "Add Category", editCategory: "Edit Category", categoryAdded: "Category added", categoryUpdated: "Category updated", categoryDeleted: "Category deleted", noCategories: "No categories", manageCategories: "Manage Categories", cart: "S.P. Cart", emptyCart: "Cart is empty", sendOrder: "Send Order", orderCreated: "Spare parts order created", orders: "Spare Parts Orders", noOrders: "No orders", price: "Price", assignedTo: "Assigned To", myself: "Myself", selectBuyer: "Select buyer" },
  ...
  reports: { title: "Reports & Analytics", topProducts: "Most Ordered Products", priceComparison: "Price Comparison", monthlySpending: "Monthly Spending", categorySpending: "Spending by Category", orderStatus: "Order Status", estimated: "Estimated", actual: "Actual", difference: "Difference", times: "times", noData: "Not enough data for reports", totalSpent: "Total Spent", avgPrice: "Avg Price", higherThanEstimated: "higher than estimated", lowerThanEstimated: "lower than estimated", orders: "orders", month: "Month", amount: "Amount" },
  attachments: { title: "Attachments", downloadTemplate: "Blank Template", exportProducts: "Export Products", exportZip: "Export ZIP", uploadExcel: "Upload Excel File", uploading: "Uploading...", processing: "Processing...", importSuccess: "Products imported successfully", importFailed: "Import failed", exportFailed: "Export failed", productsImported: "products imported", productsSkipped: "products skipped (duplicate)", productsUpdated: "products updated", selectFile: "Select Excel File", selectFileZip: "Select Excel or ZIP file", dragDrop: "or drag and drop file here", templateDesc: "Download the template, add products on your device, then upload it here", invalidFile: "Invalid file. Please upload an Excel file (.xlsx)", invalidFileZip: "Invalid file. Please upload Excel (.xlsx) or ZIP file", noData: "File contains no data", importReport: "Import Report", newProducts: "New products", existingUpdated: "Updated products", imagesLinked: "Images linked", errors: "Errors", errorDetails: "Error details", zipInfo: "Import/Export with images (ZIP)", zipImportDesc: "Import: ZIP file with Excel + images named by code (e.g., P001.jpg)", zipExportDesc: "Export: ZIP file with Excel + all product images" },
