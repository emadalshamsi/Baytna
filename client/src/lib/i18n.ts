const ar = {
  ...
  rooms: { title: "الغرف", addRoom: "إضافة غرفة", editRoom: "تعديل غرفة", nameAr: "اسم الغرفة بالعربية", nameEn: "اسم الغرفة بالإنجليزية", noRooms: "لا توجد غرف", roomAdded: "تمت إضافة الغرفة", roomUpdated: "تم تحديث الغرفة", roomDeleted: "تم حذف الغرفة", excluded: "مستثناة", includeRoom: "تفعيل الغرفة", excludeRoom: "استثناء الغرفة", assignRooms: "تعيين الغرف", assignedRooms: "الغرف المعيّنة", noAssignedRooms: "لم يتم تعيين غرف", roomsUpdated: "تم تحديث الغرف", allRooms: "كل الغرف", chooseIcon: "اختر الأيقونة", icon_door: "غرفة", icon_sofa: "صالة", icon_kitchen: "مطبخ", icon_garage: "جراج", icon_outdoor: "جلسة خارجية", icon_garden: "حديقة", icon_storage: "مخزن", icon_courtyard: "حوش", icon_home: "منزل" },
  maidHome: {
